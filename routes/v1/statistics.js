 ...
 *     curl -i 'http://mf.excess-project.eu:3040/v1/mf/statistics/ms2?metric=CPU0::PAPI_TOT_CYC'
 *
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i 'http://mf.excess-project.eu:3040/v1/mf/statistics/hpcfapix/vector_scal01?metric=DRAM_POWER:PACKAGE0&metric=DRAM_POWER:PACKAGE1&host=node01&from=2016-05-10T17:35:57.610&to=2016-05-10T17:36:57.610'
 *
 ...
 *        {
 *            "user":
 *                   {"href":"http://mf.excess-project.eu:3040/v1/mf/users/hpcfapix"},
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i 'http://mf.excess-project.eu:3040/v1/mf/statistics/hpcfapix/vector_scal01/AVSbT0ChGMPeuCn4QYjq?metric=DRAM_POWER:PACKAGE0&metric=DRAM_POWER:PACKAGE1&host=node01&from=2016-05-10T17:35:57.610&to=2016-05-10T17:36:57.610'
 *
 * @apiSuccess {Object} user link to the user
 * @apiSuccess {String} metric name of the metric
 * @apiSuccess {Object} statistics statistics of the metric during the time interval
